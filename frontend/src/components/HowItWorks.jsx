  ...
  const steps = [
    {
      ...
      title: 'CREATE',
      icon: PenTool,
      desc: 'Create your question and add custom answer options in seconds.',
    ...
    },
    {
      ...
      title: 'SHARE',
      icon: Share2,
      desc: 'Get a unique public poll link and share it with your audience.',
    ...
    },
    {
      ...
      title: 'VOTE',
      icon: Vote,
      desc: 'Your audience opens the link on any device and submits their vote.',
    ...
    },
    {
      ...
      title: 'WATCH LIVE',
      icon: Radio,
      desc: 'Everyone watching sees the results update instantly without refreshing.',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="mt-4 text-base text-slate-600">
            Engineered for speed and instant feedback. From creation to live voting in four simple steps.
          </p>
        </div>
